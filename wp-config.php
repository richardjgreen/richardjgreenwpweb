...
define('TEMPLATEPATH', 'C:\DWASFiles\Sites\richardjgreenwpweb\VirtualDirectory0\site\wwwroot\wp-content\themes\metro');
define('STYLESHEETPATH', 'C:\DWASFiles\Sites\richardjgreenwpweb\VirtualDirectory0\site\wwwroot\wp-content\themes\metro');

/** Settings for WordPress Super Cache Plugin */
define('WP_CACHE', true);
define('WPCACHEHOME', 'C:\DWASFiles\Sites\richardjgreenwpweb\VirtualDirectory0\site\wwwroot\wp-content\plugins\wp-super-cache/');

// ** SQL Azure database settings - You can get this info from your web host ** //
/** The name of the database for WordPress */
define('DB_NAME', 'richardjgreenwpsqldb');

/** SQL Azure database username */
define('DB_USER', 'wpweb_sqlrwlogin');

/** SQL Azure database password */
define('DB_PASSWORD', 'fj6fEpgEAWT9K2Z2');

/** Primary SQL Azure Server (North Europe) */
define('DB_HOST', 'pb6bfxqsy7.database.windows.net');

/** Failover SQL Azure Server (West Europe) */
/** define('DB_HOST', 'v7egoxnp92.database.windows.net'); */
...
*/
$table_prefix  = 'meANoQms_';

/** Query Logging Settings */
define('SAVEQUERIES', FALSE);
define('QUERY_LOG', 'C:\DWASFiles\Sites\richardjgreenwpweb\VirtualDirectory0\site\wwwroot/wp-content\queries.log');
